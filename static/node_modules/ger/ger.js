...
(function() {
  var Errors, GER, RET, _, bb, knex, moment,
  ...
  GER = (function() {
    ...
    GER.prototype.calculate_similarities_from_thing = function(namespace, thing, things, actions, configuration) {
      return this.esm.calculate_similarities_from_thing(namespace, thing, things, actions, _.clone(configuration));
    };

    GER.prototype.calculate_similarities_from_person = function(namespace, person, people, actions, configuration) {
    ...
    GER.prototype.filter_recommendations = function(namespace, person, recommendations, filter_previous_actions) {
    ...
    GER.prototype.filter_similarities = function(similarities) {
      var ns, pt, weight;
      ns = {};
    ...
    GER.prototype.neighbourhood_confidence = function(n_values) {
      var pc;
      pc = 1.0 - Math.pow(Math.E, (-n_values) / 15);
      return pc;
    };

    GER.prototype.history_confidence = function(n_history) {
      var hc;
      hc = 1.0 - Math.pow(Math.E, (-n_history) / 35);
      return hc;
    };

    GER.prototype.recommendations_confidence = function(recommendations) {
    ...
    GER.prototype.person_neighbourhood = function(namespace, person, actions, configuration) {
      return this.esm.person_neighbourhood(namespace, person, Object.keys(actions), _.clone(configuration));
    };

    GER.prototype.thing_neighbourhood = function(namespace, thing, actions, configuration) {
      return this.esm.thing_neighbourhood(namespace, thing, Object.keys(actions), _.clone(configuration));
    };

    GER.prototype.recent_recommendations_by_people = function(namespace, actions, people, configuration) {
      return this.esm.recent_recommendations_by_people(namespace, Object.keys(actions), people, _.clone(configuration));
    };

    GER.prototype.calculate_people_recommendations = function(similarities, recommendations, configuration) {
    ...
    GER.prototype.calculate_thing_recommendations = function(thing, similarities, neighbourhood, configuration) {
    ...
    GER.prototype.generate_recommendations_for_person = function(namespace, person, actions, person_history_count, configuration) {
    ...
    GER.prototype.generate_recommendations_for_thing = function(namespace, thing, actions, thing_history_count, configuration) {
    ...
    GER.prototype.default_configuration = function(configuration) {
    ...
    GER.prototype.normalize_actions = function(in_actions) {
    ...
    GER.prototype.recommendations_for_thing = function(namespace, thing, configuration) {
      var actions;
    ...
    GER.prototype.recommendations_for_person = function(namespace, person, configuration) {
      var actions;
      if (configuration == null) {
        configuration = {};
      }
    ...
    GER.prototype.count_events = function(namespace) {
      return this.esm.count_events(namespace);
    };

    GER.prototype.estimate_event_count = function(namespace) {
      return this.esm.estimate_event_count(namespace);
    };

    GER.prototype.events = function(events) {
      return this.esm.add_events(events).then(function() {
        return events;
      });
    };

    GER.prototype.event = function(namespace, person, action, thing, dates) {
      if (dates == null) {
        dates = {};
      }
    ...
    GER.prototype.find_events = function(namespace, options) {
      if (options == null) {
        options = {};
      }
    ...
    GER.prototype.delete_events = function(namespace, person, action, thing) {
      return this.esm.delete_events(namespace, person, action, thing);
    };

    GER.prototype.namespace_exists = function(namespace) {
      return this.esm.exists(namespace);
    };

    GER.prototype.list_namespaces = function() {
      return this.esm.list_namespaces();
    };

    GER.prototype.initialize_namespace = function(namespace) {
      return this.esm.initialize(namespace);
    };

    GER.prototype.destroy_namespace = function(namespace) {
      return this.esm.destroy(namespace);
    };

    GER.prototype.compact_database = function(namespace, options) {
      if (options == null) {
        options = {};
      }
    ...
    GER.prototype.compact_database_to_size = function(namespace, number_of_events) {
